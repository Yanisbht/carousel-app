...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Tu crees des carousels TikTok viraux sur la philosophie. Les 3 slides forment UN SEUL message narratif qui se deroule comme une revelation. Le viewer doit lire les 3 slides comme une seule phrase ou histoire. SLIDE 1 (2-5 mots) : accroche incomplete qui cree la tension, finit par ... ou un mot suspendu. Ex: 'Tout le monde dit que...' ou 'On t'a menti sur...' ou 'Tout le monde cherche...' SLIDE 2 (2-5 mots) : continue ou contredit la slide 1, apporte l'idee cle du philosophe. Ex: 'Mais l'homme sage se tait.' ou 'Mais ca n'existe pas.' SLIDE 3 (4-7 mots) : conclusion ou lecon de vie directe et percutante qui resout la tension. Ex: 'Le silence est ta vraie force.' ou 'La paix vient de l'interieur.' REGLE : les 3 slides doivent se lire ensemble comme une histoire. MAX 5 MOTS slides 1-2, MAX 7 MOTS slide 3. Theme : " + theme + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"citation\",\"sagesse\",\"tiktok\",\"fyp\",\"mindset\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"accroche incomplete MAX 5 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"suite narrative MAX 5 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"conclusion MAX 7 MOTS\"}]}";
    }

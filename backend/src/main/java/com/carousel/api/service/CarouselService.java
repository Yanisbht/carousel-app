...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Tu crees des carousels TikTok viraux sur la philosophie. TON OBLIGATOIRE : humour, autodérision, decale — comme les memes philo ou les comptes qui se moquent gentiment des philosophes. SLIDE 1 : hook DROLE et decale. EXEMPLES OBLIGATOIRES de ce style : 'Un mort te juge en ce moment.', 'Aristote kiffait pas les excuses.', 'Socrate aurait deteste ton feed.', 'Ton cerveau t'a encore menti.', 'Les anciens grecs vs toi le matin.'. Formulation familiere, moderne, qui fait sourire. MAX 5 MOTS. SLIDE 2 (3-5 mots) : la verite philosophique retournee simplement. SLIDE 3 (5-7 mots) : lecon concrete avec une pointe d'humour ou d'autodérision. Ex : 'Arrete d'avoir peur, commence.', 'Ton futur toi te remercie.', 'Moins de drama, plus d'action.'. MAX 7 MOTS. Theme : " + theme + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"citation\",\"sagesse\",\"tiktok\",\"fyp\",\"mindset\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"hook DROLE MAX 5 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"verite MAX 5 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"lecon MAX 7 MOTS\"}]}";
    }

...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Tu crees des carousels TikTok viraux sur la philosophie. OBJECTIF : la slide 1 doit etre un hook qui ARRETE le scroll et FORCE le swipe. Utilise EXACTEMENT ces formats de hook prouvés viraux : 'Tout le monde se trompe sur [X]', 'On t'a menti sur [X]', 'J'aurais aimé savoir ca plus tot', 'Ca va te choquer', 'Personne ne parle de ca', 'Tu fais ca mal', 'Le secret que [philosophe] cachait', 'Ca devrait etre illegal de savoir ca'. JAMAIS la citation elle-meme en slide 1. Slides suivantes : citation + contexte + lecon + CTA. REGLE ABSOLUE : MAX 8 MOTS par champ. Theme : " + theme + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"citation\",\"philosophie\",\"sagesse\",\"mindset\",\"tiktok\",\"fyp\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"hook viral prouvé MAX 8 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"citation percutante MAX 10 MOTS\"},{\"type\":\"context\",\"titre\":\"2 MOTS\",\"corps\":\"contexte surprenant MAX 8 MOTS\"},{\"type\":\"lesson\",\"titre\":\"2 MOTS\",\"corps\":\"lecon concrete MAX 8 MOTS\"},{\"type\":\"cta\",\"question\":\"question clivante MAX 8 MOTS ?\"}]}";
    }

...
public class CarouselService {
    ...
    public String generateEmotionnel(String theme, String style) throws Exception {
        String prompt = "Cree un carrousel TikTok 3 slides style Roman Frayssinet sur ce theme : " + theme + ". Humour + emotion + absurde. Voici des exemples PARFAITS. EXEMPLE 1 — slide1: T essaies d etre heureux depuis ce matin. slide2: C est epuisant comme job. slide3: Le bonheur c est pas un effort, c est une pause. EXEMPLE 2 — slide1: Tu relis ton message 12 fois avant envoyer. slide2: Tu l envoies quand meme. slide3: L anxiete sert a rien mais elle reste quand meme. EXEMPLE 3 — slide1: T as decide de changer demain depuis 3 ans. slide2: Demain commence jamais. slide3: Aujourd hui c est le seul demain qui existe. Humour leger, absurde, decale. Jamais moralisateur. Slide1 observation drole du quotidien MAX 7 MOTS. Slide2 retournement comique MAX 6 MOTS. Slide3 chute drole et vraie MAX 8 MOTS. Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"humour\",\"emotion\",\"vrai\",\"tiktok\",\"fyp\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"MAX 7 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"MAX 6 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"MAX 8 MOTS\"}]}";
    ...
    private String buildPrompt(String theme, String style) {
        return "Cree un carrousel TikTok 3 slides sur ce theme : " + theme + ". Voici des exemples PARFAITS avec humour et absurde. EXEMPLE 1 — slide1: Diogene a dit non a Alexandre le Grand. slide2: Alexandre avait juste trop froid. slide3: Le plus libre c etait pas celui qui regnait. EXEMPLE 2 — slide1: Socrate buvait la cigüe en souriant. slide2: Ses amis pleuraient. Lui non. slide3: Il avait compris un truc que personne voulait entendre. EXEMPLE 3 — slide1: Nietzsche est devenu fou a 44 ans. slide2: Il avait trop raison trop tot. slide3: Avoir raison tout seul c est juste etre seul. Humour OBLIGATOIRE : formulation decalee, absurde, qui fait sourire. Jamais serieux. Slide1 fait reel drole MAX 6 MOTS. Slide2 retournement absurde MAX 6 MOTS. Slide3 chute qui fait rire ET reflechir MAX 8 MOTS. Theme : " + theme + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"humour\",\"pensee\",\"tiktok\",\"fyp\",\"vrai\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"MAX 6 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"MAX 6 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"MAX 8 MOTS\"}]}";
    }
    ...
    private String buildPromptVideo(String transcription, String style) {
        String excerpt = transcription.length() > 1500 ? transcription.substring(0, 1500) : transcription;
        return "Transforme cette transcription en carrousel TikTok 3 slides style Roman Frayssinet. Humour + absurde + emotion. Voici des exemples PARFAITS. EXEMPLE 1 — slide1: Tu procrastines depuis ce matin... slide2: C est pas de la flemme. slide3: Ton cerveau evite un echec qu il a invente. EXEMPLE 2 — slide1: Tu te compares aux autres encore... slide2: Leur vie est un highlight reel. slide3: T as l integrale de la tienne. EXEMPLE 3 — slide1: Tu relis ce message depuis 10 minutes... slide2: Il est bien. Tu le sais. slide3: L anxiete convainc meme quand elle a tort. Meme structure : slide1 observation du quotidien drole avec ... MAX 6 MOTS. Slide2 retournement absurde ou comique MAX 6 MOTS. Slide3 chute drole et vraie qui reste MAX 8 MOTS. Extrait l idee principale et applique ce style : " + excerpt + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"humour\",\"pensee\",\"vrai\",\"tiktok\",\"fyp\"],\"slides\":[{\"type\":\"video_hook\",\"concept\":\"2 mots\",\"accroche\":\"MAX 6 MOTS\"},{\"type\":\"video_explication\",\"titre\":\"2 MOTS\",\"corps\":\"MAX 6 MOTS\"},{\"type\":\"video_cta\",\"texte\":\"MAX 8 MOTS\",\"question\":\"\"}]}";
    }

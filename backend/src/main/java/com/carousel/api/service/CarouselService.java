...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Tu crees des carousels TikTok viraux sur la philosophie avec UNE TOUCHE D'HUMOUR. Style : Cyrus North — la philo expliquee comme un pote, avec des references modernes et une formulation drole ou absurde. Les 3 slides forment une seule histoire fluide. SLIDE 1 (3-5 mots) : hook drole ou absurde qui accroche. Ex: 'Un mort avait tout prevu...' 'Aristote avait vu venir ca...' 'Un grec mort te juge...' 'Tout le monde cherche ca...' SLIDE 2 (3-5 mots) : la revelation surprenante ou le retournement. Direct, concret, pas de jargon. SLIDE 3 (5-7 mots) : lecon de vie applicable aujourd'hui, peut finir sur une note legere ou percutante. REGLE : les 3 slides se lisent comme une blague qui finit bien. MAX 5 MOTS slides 1-2, MAX 7 MOTS slide 3. Theme : " + theme + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"citation\",\"sagesse\",\"tiktok\",\"fyp\",\"mindset\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"hook drole MAX 5 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"revelation MAX 5 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"lecon MAX 7 MOTS\"}]}";
    }
    ...
    private String buildPromptVideo(String transcription, String style) {
        String excerpt = transcription.length() > 1500 ? transcription.substring(0, 1500) : transcription;
        return "Tu crees des carousels TikTok VIRAUX a partir de transcriptions. Sujet : developpement perso, psychologie, lifestyle. FORMAT : 3 slides. TON : humour leger + verite qui choque. Comme Cyrus North — fun, direct, pas chiant. SLIDE 1 : question drole ou decalee que tout le monde se pose. Ex : 'Mais pourquoi tu procrastines ?', 'Ton cerveau te ment, voila comment', 'Un grec mort avait tout compris sur toi'. MAX 6 MOTS, percutant. SLIDE 2 : la reponse contre-intuitive et surprenante. Ce que les gens savent pas. MAX 8 MOTS. SLIDE 3 : la lecon concrete avec une touche d'humour ou d'autodérision. Ex : 'Arrete de subir, choisis.', 'Ton futur toi te remercie.'. MAX 8 MOTS. Transcription : " + excerpt + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"psychologie\",\"developpementperso\",\"mindset\",\"philosophie\",\"tiktok\",\"fyp\"],\"slides\":[{\"type\":\"video_hook\",\"concept\":\"sujet 2 mots\",\"accroche\":\"question directe MAX 6 MOTS ?\"},{\"type\":\"video_explication\",\"titre\":\"2 MOTS\",\"corps\":\"reponse surprenante MAX 8 MOTS\"},{\"type\":\"video_cta\",\"texte\":\"lecon actionnable MAX 8 MOTS\",\"question\":\"\"}]}";
    }

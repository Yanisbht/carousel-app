...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Tu crees des carousels TikTok viraux sur la philosophie. Les 3 slides forment UNE SEULE PHRASE qui se lit en swipant. Le viewer doit comprendre le lien immediatement. EXEMPLE PARFAIT : 'Tout le monde cherche le bonheur...' → 'Il est dans le present.' → 'Arrete de courir, vis maintenant.' SLIDE 1 (3-5 mots) : debut de phrase avec un sujet clair + ... Ex: 'Tout le monde cherche...' 'On t'a menti sur X...' 'X dit que tu dois...' SLIDE 2 (3-5 mots) : retournement ou revelation qui complete la slide 1 logiquement. Ex: 'Mais X dit non.' 'C'est deja en toi.' 'Tu te trompes.' SLIDE 3 (5-7 mots) : lecon de vie concrete et directe. Ex: 'Vis maintenant, pas apres.' 'Le silence est ta force.' REGLE ABSOLUE : les 3 slides doivent se lire comme 1 phrase fluide. MAX 5 MOTS slides 1-2, MAX 7 MOTS slide 3. Theme : " + theme + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"citation\",\"sagesse\",\"tiktok\",\"fyp\",\"mindset\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"debut de phrase MAX 5 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"retournement MAX 5 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"lecon MAX 7 MOTS\"}]}";
    }
    ...
    private String buildPromptVideo(String transcription, String style) {
        String excerpt = transcription.length() > 1500 ? transcription.substring(0, 1500) : transcription;
        return "Tu crees des carousels TikTok VIRAUX a partir de transcriptions. Sujet : developpement perso, psychologie, lifestyle — des sujets que tout le monde vit au quotidien. FORMAT : 3 slides seulement. SLIDE 1 (hook) : question courte et directe que tout le monde se pose dans sa vie. Exemples qui marchent : 'Mais c'est quoi une idee ?', 'Pourquoi tu procrastines ?', 'Comment arreter de te comparer ?', 'Pourquoi tu cherches la validation ?'. MAX 6 MOTS, finit par ?. SLIDE 2 : la reponse surprenante et contre-intuitive vulgarisee comme un ami. Quelque chose que les gens savent pas. MAX 8 MOTS. SLIDE 3 : la lecon concrete applicable aujourd'hui, actionnable immediatement. MAX 8 MOTS. Ton : naturel, direct, comme un ami qui te dit une verite. Pas de jargon philosophique. Transcription : " + excerpt + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"psychologie\",\"developpementperso\",\"mindset\",\"philosophie\",\"tiktok\",\"fyp\"],\"slides\":[{\"type\":\"video_hook\",\"concept\":\"sujet 2 mots\",\"accroche\":\"question directe MAX 6 MOTS ?\"},{\"type\":\"video_explication\",\"titre\":\"2 MOTS\",\"corps\":\"reponse surprenante MAX 8 MOTS\"},{\"type\":\"video_cta\",\"texte\":\"lecon actionnable MAX 8 MOTS\",\"question\":\"\"}]}";
    }

...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Tu crees des carousels TikTok viraux sur la philosophie. OBJECTIF : la slide 1 doit etre INCOMPLETE et creer une tension qui FORCE le swipe. La slide 1 ne doit JAMAIS donner la reponse ou la citation complete — elle pose une promesse, une question, un mystere. Les gens doivent swiper pour avoir la suite. REGLE ABSOLUE : MAX 8 MOTS par champ. Pas de jargon philosophique. Parle comme un ami. Theme : " + theme + ". Structure : Slide 1 (HOOK TENSION) : une phrase incomplete qui cree de la curiosite et force le swipe. Exemples : 'Cette phrase a change ma vision de la vie.' ou 'Voila pourquoi tu souffres sans le savoir.' ou 'Un philosophe mort a resolu ton plus gros probleme.' — jamais la citation elle-meme. Slide 2 : la citation complete et percutante. Slide 3 : le contexte surprenant en 1 phrase. Slide 4 : la lecon concrete pour aujourd'hui. Slide 5 : question clivante pour les commentaires. Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"citation\",\"philosophie\",\"sagesse\",\"mindset\",\"tag5\",\"tag6\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"hook de tension INCOMPLET MAX 8 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"la vraie citation MAX 10 MOTS\"},{\"type\":\"context\",\"titre\":\"2 MOTS\",\"corps\":\"contexte surprenant MAX 8 MOTS\"},{\"type\":\"lesson\",\"titre\":\"2 MOTS\",\"corps\":\"lecon concrete MAX 8 MOTS\"},{\"type\":\"cta\",\"question\":\"question qui divise MAX 8 MOTS ?\"}]}";
    }
    ...
    private String buildPromptVideo(String transcription, String style) {
        String excerpt = transcription.length() > 1500 ? transcription.substring(0, 1500) : transcription;
        return "Tu crees des carousels TikTok viraux a partir de transcriptions YouTube. OBJECTIF : la slide 1 doit creer une TENSION qui force le swipe — elle pose une promesse sans la tenir, comme 'Cette idee va changer ta facon de voir les choses.' ou 'Personne t'a jamais explique ca aussi simplement.' ou 'La vraie reponse est dans la slide suivante.' JAMAIS donner l'idee principale en slide 1. Naturel, accessible, comme un ami. REGLE ABSOLUE : MAX 8 MOTS par champ. Transcription : " + excerpt + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"citation\",\"sagesse\",\"mindset\",\"tag5\",\"tag6\"],\"slides\":[{\"type\":\"video_hook\",\"concept\":\"sujet en 2 mots\",\"accroche\":\"hook tension INCOMPLET force le swipe MAX 8 MOTS\"},{\"type\":\"video_explication\",\"titre\":\"2 MOTS\",\"corps\":\"premiere idee cle MAX 8 MOTS\"},{\"type\":\"video_explication\",\"titre\":\"2 MOTS\",\"corps\":\"deuxieme idee cle MAX 8 MOTS\"},{\"type\":\"video_exemple\",\"exemple\":\"exemple concret MAX 8 MOTS\"},{\"type\":\"video_cta\",\"texte\":\"phrase fun MAX 6 MOTS\",\"question\":\"question MAX 7 MOTS ?\"}]}";
    }

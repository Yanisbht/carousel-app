...
public class CarouselService {
    ...
    private String buildPromptVideo(String transcription, String style) {
        String excerpt = transcription.length() > 1500 ? transcription.substring(0, 1500) : transcription;
        return "Tu crees des carousels TikTok viraux a partir de transcriptions YouTube. FORMAT STRICT : 3 slides seulement. OBJECTIF : reproduire le succes du format 'Mais c'est quoi une idee ?' de Cyrus North — une vraie question du quotidien que tout le monde se pose, une reponse simple et surprenante, une lecon de vie directe. SLIDE 1 (hook) : une vraie question simple et directe que tout le monde se pose dans sa vie. Style 'Mais c'est quoi X ?' ou 'Pourquoi tu arrives pas a Y ?' ou 'C'est quoi vraiment X ?'. MAX 6 MOTS. SLIDE 2 : la reponse surprenante du philosophe ou de la video, vulgarisee simplement comme un ami. MAX 8 MOTS. SLIDE 3 : la lecon de vie concrete que tu peux appliquer aujourd'hui. MAX 8 MOTS. Pas de jargon. Naturel. Direct. Transcription : " + excerpt + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"citation\",\"sagesse\",\"mindset\",\"tiktok\",\"fyp\"],\"slides\":[{\"type\":\"video_hook\",\"concept\":\"sujet 2 mots\",\"accroche\":\"question directe MAX 6 MOTS ?\"},{\"type\":\"video_explication\",\"titre\":\"2 MOTS\",\"corps\":\"reponse surprenante MAX 8 MOTS\"},{\"type\":\"video_cta\",\"texte\":\"lecon de vie MAX 8 MOTS\",\"question\":\"\"}]}";
    }

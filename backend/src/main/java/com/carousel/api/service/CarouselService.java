...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Genere un carrousel TikTok en 3 slides sur ce theme : " + theme + ". REGLE N1 : le hook DOIT etre drole, decale, familier — jamais serieux. Copie exactement ce style pour le hook : 'Aristote kiffait pas les excuses.' / 'Un mort te juge en ce moment.' / 'Socrate aurait deteste ton feed.' / 'Ton cerveau t'a encore menti.' / 'Les grecs anciens vs toi le matin.'. SLIDE 1 = hook drole sur le theme, MAX 5 MOTS, meme ton que les exemples. SLIDE 2 = verite philosophique simple et directe, MAX 5 MOTS. SLIDE 3 = lecon actionnable avec humour, MAX 7 MOTS. Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"citation\",\"sagesse\",\"tiktok\",\"fyp\",\"mindset\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"hook drole MAX 5 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"verite MAX 5 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"lecon MAX 7 MOTS\"}]}";
    }

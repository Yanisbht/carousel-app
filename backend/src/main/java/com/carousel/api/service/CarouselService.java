...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Tu crees un carrousel TikTok qui raconte une MINI-HISTOIRE philosophique en 3 slides. Format : film court avec humour. SLIDE 1 (hook) : une phrase courte et drole qui pose le decor avec un personnage ou fait reel surprenant. MAX 5 MOTS. Exemples : 'Socrate s'est fait tuer pour ca.' / 'Diogene vivait dans un tonneau.' / 'Marc Aurele regnait sur le monde.' / 'Epictete etait esclave, puis libre.' / 'Nietzsche aimait pas les excuses.'. SLIDE 2 (histoire) : l'anecdote surprenante en 1 phrase courte. Ce qui s'est vraiment passe. MAX 6 MOTS. Ex : 'Il posait juste des questions.' / 'Il refusait tout ce qu'on lui offrait.' / 'Il ecrivait pour lui, pas les autres.'. SLIDE 3 (lecon) : la lecon qui relie cette histoire a ta vie aujourd'hui. Directe, actionnable, avec une pointe d'humour. MAX 7 MOTS. Ex : 'Questionne tout. Surtout toi.' / 'La liberte c'est vouloir moins.' / 'Agis bien meme si personne regarde.'. REGLE : les 3 slides forment une mini-histoire complete. Theme : " + theme + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"histoire\",\"sagesse\",\"tiktok\",\"fyp\",\"mindset\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"hook personnage reel MAX 5 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"anecdote surprenante MAX 6 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"lecon de vie MAX 7 MOTS\"}]}";
    }
    ...
    private String buildPromptVideo(String transcription, String style) {
        String excerpt = transcription.length() > 1500 ? transcription.substring(0, 1500) : transcription;
        return "Tu crees des carousels TikTok VIRAUX a partir de transcriptions. TON OBLIGATOIRE : humour leger, decale, autodérision — comme les memes philo ou Cyrus North. FORMAT : 3 slides. SLIDE 1 : hook drole et familier. EXEMPLES : 'Un mort avait tout compris sur toi.', 'Ton cerveau t'a encore menti.', 'Aristote kiffait pas les excuses.', 'Mais c'est quoi [sujet] vraiment ?', 'Pourquoi tu fais ca encore ?'. MAX 6 MOTS, finit par . ou ?. SLIDE 2 : la reponse surprenante et contre-intuitive. Quelque chose que les gens savent pas. MAX 8 MOTS. SLIDE 3 : lecon actionnable avec une touche d'humour. Ex : 'Ton futur toi te remercie.', 'Moins de drama, plus d'action.', 'Arrete de subir, commence.'. MAX 8 MOTS. Transcription : " + excerpt + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"psychologie\",\"developpementperso\",\"mindset\",\"philosophie\",\"tiktok\",\"fyp\"],\"slides\":[{\"type\":\"video_hook\",\"concept\":\"sujet 2 mots\",\"accroche\":\"question directe MAX 6 MOTS ?\"},{\"type\":\"video_explication\",\"titre\":\"2 MOTS\",\"corps\":\"reponse surprenante MAX 8 MOTS\"},{\"type\":\"video_cta\",\"texte\":\"lecon actionnable MAX 8 MOTS\",\"question\":\"\"}]}";
    }

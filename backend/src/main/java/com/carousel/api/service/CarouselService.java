...
public class CarouselService {
    ...
    private String buildPrompt(String theme, String style) {
        return "Tu crees des carousels TikTok viraux sur la philosophie. Format STRICT : 3 slides, MAX 4 MOTS par slide. Style : grosse typographie qui claque, texte court et impactant comme une affiche. SLIDE 1 (2-4 mots) : hook choc ex: 'Tout le monde se trompe.' ou 'On t'a menti.' ou 'Tu fais ca mal.' SLIDE 2 (2-4 mots) : l'idee philo en langage simple ex: 'La douleur c'est toi.' ou 'Le present suffit.' SLIDE 3 (2-4 mots) : lecon directe ex: 'Choisis ta reaction.' ou 'Agis. Maintenant.' REGLE ABSOLUE : MAX 4 MOTS par champ. Compte les mots. Theme : " + theme + ". Retourne UNIQUEMENT ce JSON sans backticks : {\"hashtags\":[\"philosophie\",\"citation\",\"sagesse\",\"tiktok\",\"fyp\",\"mindset\"],\"slides\":[{\"type\":\"hook\",\"citation\":\"MAX 4 MOTS\",\"auteur\":\"\",\"origine\":\"\"},{\"type\":\"intrigue\",\"question\":\"MAX 4 MOTS\"},{\"type\":\"lesson\",\"titre\":\"\",\"corps\":\"MAX 4 MOTS\"}]}";
    }
